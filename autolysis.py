...
for csv_file in CSV_FILES:
    ...
    response = openai.ChatCompletion.create(
       model="gpt-4o-mini",
      messages=[
          {"role": "system", "content": "You are a data analysis assistant."},  # System message (optional)
          {"role": "user", "content": "The dataset contains these columns: ['Title', 'Genre', 'Rating', 'Pages']. Suggest deeper analysis techniques."}  # User message
      ],
      max_tokens=300,
      temperature=0.7
    )
